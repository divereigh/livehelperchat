<script> $(function() { $( "#online_visitors" ).resizable();});</script>

<div id="online_visitors" class="panel panel-default panel-dashboard" data-panel-id="online_visitors" ng-init="lhc.getToggleWidget('onvisitors_widget_exp')">
