...
if ($canListOnlineUsers == true || $canListOnlineUsersAll == true) {
	...
	erLhcoreClassChat::prefillGetAttributes($onlineOperators,array('lastactivity_ago','user_id','id','name_support','active_chats','departments_names','hide_online'),array(),array('remove_all' => true));
